...
MSG_EARN_INTRO = (
    "💰 <b>کسب درآمد با کیف داده</b>\n\n"
    "با این قابلیت می‌توانید از اشتراک خود درآمد کسب کنید:\n\n"
    "✅ <b>چطور کار می‌کند؟</b>\n"
    "هر بار که یک اشتراک می‌خرید، حجم آن در اختیار شماست.\n"
    "می‌توانید از آن حجم، کانفیگ‌های کوچک‌تر بسازید و به دیگران بفروشید.\n\n"
    "📌 <b>مثال:</b>\n"
    "شما یک اشتراک ۲۰ گیگ دارید.\n"
    "• یک کانفیگ ۵ گیگ برای دوستتان می‌سازید و می‌فروشید\n"
    "• یک کانفیگ ۱۰ گیگ برای مشتری دیگری می‌سازید\n"
    "• ۵ گیگ هم برای خودتان باقی می‌ماند\n\n"
    "⚙️ <b>ویژگی‌ها:</b>\n"
    "• کانفیگ فرزند همان تاریخ انقضای اشتراک اصلی را دارد\n"
    "• حجم دلخواه — از ۱۰۰ مگابایت تا هر مقدار\n"
    "• انتقال فوری به شناسه تلگرام گیرنده\n"
    "• موجودی سرویس اصلی شما بلادرنگ کاهش می‌یابد\n\n"
